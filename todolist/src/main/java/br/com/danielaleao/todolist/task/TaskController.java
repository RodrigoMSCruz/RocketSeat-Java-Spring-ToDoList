package br.com.danielaleao.todolist.task;
...
import br.com.danielaleao.todolist.util.Utils;
...
public class TaskController {
    ...
    public ResponseEntity<Object> update(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id){
        ...
        if(!task.getIdUser().equals(idUser)){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Usuário sem permissão para editar essa tarefa.");
        }
